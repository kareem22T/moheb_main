    ...
    <div class="card-body">
        <div>
            ...
            <div class="pop-up show-images-pop-up card" v-if="showImages" style="z-index: 2147483647; min-width: 90vw; height: 90vh; padding: 20px; display: flex; flex-direction: column; justify-content: space-between; gap: 1rem;max-width: 100vw;">
                ...
                <div class="img" :class="{ 'selected': choosed_img == (this.choosed_img = '/dashboard/images/uploads/' + img.path) }" @click="this.choosed_img = '/dashboard/images/uploads/' + img.path" v-for="(img, index) in images" :key="img.id" style="width: 260px;height: 230px;overflow: hidden;padding: 10px;border-radius: 1rem;box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;">
                    <div class="img" @click="this.choosed_img = '/dashboard/images/uploads/' + img.path" v-for="(img, index) in images" :key="img.id"                     :style="{
                        width: '260px',
                        height: '230px',
                        overflow: 'hidden',
                        padding: '10px',
