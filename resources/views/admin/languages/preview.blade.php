...
<div class="card w-100" id="lang_prev">
    <div class="card-header d-flex justify-content-between gap-3">
        ...
        <a href="/moheb2/admin/languages/add" class="btn btn-primary w-fit d-flex gap-2 align-items-center">
...
createApp({
    ...
    methods: {
        ...
        async deleteLang(lang_id) {
            $('.loader').fadeIn().css('display', 'flex')
            try {
                const response = await axios.post(`/moheb2/admin/languages/delete`, {
                    lang_id: lang_id,
                },
                );
                if (response.data.status === true) {
        ...
        async getLanguages() {
            $('.loader').fadeIn().css('display', 'flex')
            try {
                const response = await axios.post(`/moheb2/admin/languages?page=${this.page}`, {
                },
                );
                if (response.data.status === true) {
                    $('.loader').fadeOut()
        ...
        async getSearch(search_words) {
            try {
                const response = await axios.post(`/moheb2/admin/languages/search?page=${this.page}`, {
