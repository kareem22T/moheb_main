<header>
    <div class="dark-top" style="align-items: center; gap: 4px;background: #212121;width: 100%;padding: 8px;font-size: 13px;display: flex;justify-content: center;font-family: cairo; color: #fff">
        ...
        Supports Visually impaired | يدعم تصفح المكفوفين
    </div>
    <div class="top">
        <div class="container">
        ...
        <div class="container" style="overflow: visible !important">
            ...
            <div class="mobile-menu">
                ...
                <div class="links">
                    <a href="/about-us">@{{ page_content ? page_content.header.about : "About" }}</a>
                    <a href="/contact-us">@{{ page_content ? page_content.header.contact : "Contact" }}</a>
                    <a href="/coming-soon">@{{ page_content ? page_content.header.blog : "Blog" }}</a>
                    <a href="/coming-soon">@{{ page_content ? page_content.header.translation : "Translation" }}</a>
                </div>
